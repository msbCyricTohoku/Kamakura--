...
DISTDIR = /home/ben/Kamakura--/.tmp/Kamakura1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -pipe -O2 -std=gnu++1z -flto=48 -fno-fat-lto-objects -fuse-linker-plugin -fPIC
...
SOURCES       = src/airequester.cpp \
		...
		src/kamakura.cpp \
		src/metrics.cpp \
		src/notebookeditor.cpp qrc_resources.cpp \
		moc_airequester.cpp \
		moc_codeeditor.cpp \
		moc_finddialog.cpp \
		moc_highlighter.cpp \
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		src/metrics.h \
		src/notebookeditor.h src/airequester.cpp \
		src/codeeditor.cpp \
		src/finddialog.cpp \
		src/highlighter.cpp \
		src/main.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/airequester.h src/codeeditor.h src/documentmetrics.h src/finddialog.h src/highlighter.h src/kamakura.h src/linenumberarea.h src/metrics.h src/notebookeditor.h $(DISTDIR)/
	$(COPY_FILE) --parents src/airequester.cpp src/codeeditor.cpp src/finddialog.cpp src/highlighter.cpp src/main.cpp src/kamakura.cpp src/metrics.cpp src/notebookeditor.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_airequester.cpp moc_codeeditor.cpp moc_finddialog.cpp moc_highlighter.cpp moc_kamakura.cpp moc_metrics.cpp moc_notebookeditor.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_airequester.cpp moc_codeeditor.cpp moc_finddialog.cpp moc_highlighter.cpp moc_kamakura.cpp moc_metrics.cpp moc_notebookeditor.cpp
...
moc_notebookeditor.cpp: src/notebookeditor.h \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/ben/Kamakura--/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/ben/Kamakura-- -I/home/ben/Kamakura--/src -I/usr/include/qt -I/usr/include/qt/QtPrintSupport -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtXml -I/usr/include/qt/QtNetwork -I/usr/include/qt/QtCore -I/usr/include/c++/15.2.1 -I/usr/include/c++/15.2.1/x86_64-pc-linux-gnu -I/usr/include/c++/15.2.1/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/15.2.1/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/15.2.1/include-fixed -I/usr/include src/notebookeditor.h -o moc_notebookeditor.cpp
...
notebookeditor.o: src/notebookeditor.cpp src/notebookeditor.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o notebookeditor.o src/notebookeditor.cpp
...
moc_notebookeditor.o: moc_notebookeditor.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_notebookeditor.o moc_notebookeditor.cpp
